...
TrafficMap.prototype.load_live_cams = function (cam_url) {
	...
	jQuery.ajax({
		...
		success: function (cameras) {
			...
			function make_marker (dom) {
				var id = dom.getAttribute("id");
				var name = dom.getAttribute("name");
				var lon = dom.getElementsByTagName("location")[0].getAttribute("lon");
				var lat = dom.getElementsByTagName("location")[0].getAttribute("lat");
				var height = dom.getElementsByTagName("size")[0].getAttribute("height");
				var width = dom.getElementsByTagName("size")[0].getAttribute("width");
